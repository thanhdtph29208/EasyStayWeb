<!-- Trong tệp payment_success.blade.php -->
<!DOCTYPE html>
<html>
<head>
...
<div class="bg-gray-100 h-screen">
      <div class="bg-white p-6  md:mx-auto">
        ...
        <div class="text-center">
            ...
            <p class="text-gray-600 my-2">Cảm ơn bạn vì đã sử dụng dịch vụ của chúng tôi!</p>
            <p> Hẹn gặp lại, chúc bạn có 1 ngày tốt lành  </p>
