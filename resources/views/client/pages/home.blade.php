            ...
            <div class="swiper-wrapper">
                @foreach ($banners as $key => $banner)
                    <div class="swiper-slide flex items-center overflow-hidden">
                        <div class="slide-inner absolute end-0 top-0 w-full h-full slide-bg-image flex items-center bg-center carousel-item {{ $key == 0 ? 'active' : '' }};"
                            data-background="{{ asset($banner->anh) }}">
                                ...
                                <div class="grid grid-cols-1">
                                    <div class="text-center">
                                        ...
                                        <h1
                                            ...
                                            Find Your Best <br> Hotels Package</h1>
                                        <p class="text-white/70 text-xl max-w-xl mx-auto">Cần một nơi dừng chân cho một
                ...
                <form class="p-6 bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700" method="post"
                    ...
                    <div class="registration-form text-dark text-start">
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
                            <div>
                                <label class="form-label font-medium text-slate-900 dark:text-white">Lựa chọn ngày
                                    đến:</label>
    ...
    <section class="relative md:py-24 py-16 overflow-hidden">
        ...
        <div class="container relative">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-6 relative">
                <div class="md:col-span-5">
                    <div class="relative">
                        <img src="assets/images/about.jpg" class="mx-auto rounded-3xl shadow dark:shadow-gray-700 w-[90%]"
                            alt="">
                ...
                <div class="md:col-span-7">
                    <div class="lg:ms-8">
                        <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Nơi nên dừng
                            chân: <br> EasyStayHotel</h3>
        ...
        <div class="container relative md:mt-24 mt-16">
            <div class="grid grid-cols-1 pb-8 text-center">
                ...
                <p class="text-slate-400 max-w-xl mx-auto">Cần một nơi dừng chân cho một chuyến đi? Chúng tôi sẽ mang đến
                    cho các bạn nơi nghỉ dưỡng với những trải nghiệm tốt nhất!</p>
            </div><!--end grid-->
                    ...
                    <div class="group rounded-md shadow dark:shadow-gray-700">
                        <div class="md:flex md:items-center">
                            <div
                                ...
                                <img src="{{ Storage::url($loai_phong->anh) }}"
                                ...
                                <div class="absolute top-0 start-0 p-4">
                                    <span
                                        class="bg-red-500 text-white text-[12px] px-2.5 py-1 font-medium rounded-md h-5">EasyStay</span>
                                </div>
        ...
        <div class="container relative md:mt-24 mt-16">
            <div class="grid grid-cols-1 pb-6 text-center">
                ...
                <p class="text-slate-400 max-w-xl mx-auto">Với những trải nghiệm và dịch vụ của chúng tôi, các bạn hãy khám
                    phá để không bỏ lỡ nhé.</p>
            </div><!--end grid-->
                ...
                @foreach ($bai_viets as $bai_viet)
                    <div class="group relative overflow-hidden">
                        <div class="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                            <img src="{{ Storage::url($bai_viet->anh) }}"
                            ...
                            <div class="absolute top-0 start-0 p-4 opacity-0 group-hover:opacity-100 duration-500">
                                <span
                                    class="bg-red-500 text-white text-[12px] px-2.5 py-1 font-medium rounded-md h-5">Hotel</span>
                            </div>
                        </div>

                        <div class="mt-6">
                            <div class="flex mb-4">
                                <span class="flex items-center text-slate-400 text-sm"><i data-feather="clock"
                                        class="size-4 text-slate-900 dark:text-white me-1.5"></i>{{ $bai_viet->created_at }}</span>
                            ...
                            <a href="blog-detail.html"
                                class="text-lg font-medium hover:text-red-500 duration-500 ease-in-out">{{ $bai_viet->tieu_de }}</a>
                            <p class="text-slate-400 mt-2">{{ $bai_viet->mo_ta_ngan }}</p>

                            <div class="mt-3">
                                <a href="<?= env('APP_URL') ?>/chi_tiet_tin_tuc/<?= $bai_viet->id ?>"
                                    class="hover:text-red-500 inline-flex items-center">Đọc tiếp <i
                                        data-feather="chevron-right" class="size-4 ms-1"></i></a>
                            </div>
                        </div>
                    </div><!--end content-->
                @endforeach
