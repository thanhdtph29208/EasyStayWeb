        ...
        $('#filterFormtrangthai').submit(function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Hiển thị thông tin của mỗi loại phòng
                    data.rooms.forEach(function(room) {
                        var statusText = room.trang_thai == 0 ? 'Hết phòng' : 'Còn phòng';
                        var statusClass = room.trang_thai == 0 ? 'bg-gray-500 text-white' : 'bg-green-500 text-white';
...
<div class="flex justify-between items-center">
    ...
    <form action="{{ route('client.pages.loai_phong.filter') }}" id="filterFormtrangthai" method="GET" class="flex items-center justify-between mb-6 mr-4">
        <div class="flex items-center space-x-4">
...
<a href="<?= env('APP_URL') ?>loai_phong" class="sub-menu-item">Xóa bộ lọc</a>
</button>
 </div>
</div>
