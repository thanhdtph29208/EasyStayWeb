                                    ...
                                    @foreach ($danh_gias as $key => $item)
                                        <table>
                                            <tr>
                                                <td>
                                                    <span
                                                        class="size-8 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-slate-500 text-white bg-slate-400">
                                                        <img class="rounded-full " width="45px"
                                                            src="{{ Storage::url($item->user['anh']) }}" alt="">
                                                    </span>
                                                </td>
                                                <td>
                                                    <ul class="pt-4 ps-2">
                        ...
                        <form class="px-3" action="{{ route('admin.danh_gia.store', $detail) }}" method="post">
                            ...
                            <div class="mt-6  ">
                                ...
                                <div class="input-group my-2 ">
                                    <textarea class="form-control border border-gray-300 w-full rounded-sm" aria-label="With textarea" rows="4"
                                        placeholder="Nhập phần bình luận của bạn ở đây" name="noi_dung"></textarea>
                                </div>
                            </div>

                            <button
                                class="py-2 px-5 mb-2 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md w-25 ">
                                Gửi
                            </button>
                    ...
                    <div class="p-4 rounded-md shadow dark:shadow-gray-700 sticky top-20">
                        <div>
                            ...
                            <input name="date" type="text"
                                class="mt-2 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0 start placeholder:m-3"
