        ...
        <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
            <ul class="tracking-[0.5px] mb-0 inline-block">
                <li
                    ...
                    <a href="<?= env('APP_URL') ?>/">EasyStay</a></li>
                    ...
                    <div class="group relative overflow-hidden">
                        ...
                        <div class="mt-6">
                            <div class="flex mb-4">
                                ...
                                <span class="text-slate-400 text-sm ms-3">by <a href="#"
                                        class=" dark:text-white text-red-500 dark:hover:text-red-500 font-medium">Travosy</a></span>
                            </div>

                            <a href="<?= env('APP_URL') ?>/chi_tiet_tin_tuc/<?= $item->id ?>"
                                class="text-lg font-medium hover:text-red-500 duration-500 ease-in-out">{{ $item->tieu_de }}</a>
                            <p class="text-slate-400 mt-2">{{ $item->mo_ta_ngan }}</p>

                            <div class="mt-3">
                                <a href="<?= env('APP_URL') ?>/chi_tiet_tin_tuc/<?= $item->id ?>"
                                    class="hover:text-red-500 inline-flex items-center">Chi tiết<i
