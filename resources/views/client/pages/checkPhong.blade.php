        ...
        <div class="absolute text-center z-10 bottom-5 start-0 end-0 mx-3">
            <ul class="tracking-[0.5px] mb-0 inline-block">
                ...
                <li class="inline-block uppercase text-[13px] font-bold duration-500 ease-in-out text-white"
                    aria-current="page">Tra cứu phòng</li>
            </ul>
        </div>
    </section><!--end section-->
                ...
                @foreach ($availableLoaiPhongs as $loaiPhong)
                        ...
                        <div class="group rounded-md shadow dark:shadow-gray-700 my-6  ">
                            <div class="md:flex md:items-center cd-item-parent">
                                <div
                                    class="relative overflow-hidden md:shrink-0 md:rounded-md rounded-t-md shadow dark:shadow-gray-700 md:m-3 mx-3 mt-3 cd-item">
                                    <img src="{{ Storage::url($loaiPhong->anh) }}"
                                        class="h-full w-full object-cover md:w-50 md:h-56 scale-125 group-hover:scale-100 duration-500"
                                        data-id="{{ $loaiPhong->id }}" alt="">
                                ...
                                <div class="p-4 ml-2 w-full">
                                    ...
                                    <form action="" class="book-cart">
                                        ...
                                        <div
                                            class="mt-2 pt-4 flex justify-between items-center border-t border-slate-100 dark:border-gray-800">
                                            ...
                                            @foreach ($phongs as $phong)
                                                @if ($phong['loai_phong']->id == $loaiPhong->id)
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="number" id="qty" name="so_luong" min="1"
                                                            value="1" max="{{ $phong['available_rooms']->count() }}">
                                                    </div>

                                                    <div>
                                                        <label for="so_luong_nguoi">Số lượng người:</label>
                                                        <input type="number" name="so_luong_nguoi" id="so_luong_nguoi"
                                                            value="1" min="1"
                                                            max="{{ $phong['loai_phong']->gioi_han_nguoi }}">
                                                    </div>
                                                @endif
                                            @endforeach
                                    ...
                                    <a class="mt-3 py-1 px-3 h-10 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md cursor-pointer hover:bg-slate-800 cd-trigger"
                                        href="#0">Xem chi tiết</a>
