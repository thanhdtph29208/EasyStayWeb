        ...
        <div class="flex flex-row">
            ...
            <div class="w-1/4 ms-5 px-4 py-5 shadow-md">
                ...
                <div class="mt-2">
                    ...
                    <p class="text-red-600 text-sm">(Theo quy định của Ngân hàng Nhà nước Việt Nam, Quý khách vui lòng thanh toán bằng VNĐ)</p>
                </div>

                <button type="submit" class="bg-blue-500 text-white hover:bg-red-700 font-bold py-2 px-4 rounded w-full mt-4">Thanh toán</button>

                <!-- 
                <div class="bg-gray-100 shadow-md rounded px-4 py-5">
                    <div class="flex flex-col items-center">
                        <h5 class="text-xl font-bold mb-2">Total</h5>
                        <p class="text-red-500 font-bold text-lg">{{ number_format($cartTotal, 0, '.', '.') }}</p>
                    </div>
                    <input type="hidden" name="cart_total" value="{{ $cartTotal }}">
                    <button type="submit" class="bg-blue-500 text-white hover:bg-blue-700 font-bold py-2 px-4 rounded w-full mt-4">Pay</button>
                </div> -->
            </div>
        </div>
    </form>
