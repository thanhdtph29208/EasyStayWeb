                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center">
                                    ...
                                    <input type="text" class="form-control w-16 px-2 py-1 text-center phong-qty" value="{{ $item->qty }}" readonly data-rowid="{{ $item->rowId }}" max="">
        ...
        <div class="p-4">
            ...
            <form class="mb-3" action="{{ route('checkout') }}" method="get">
                ...
                <div class="flex items-center justify-between mt-2">
                    ...
                    <input type="hidden" value="{{ $total * $soNgay }}" name="cart_total" id="input_cart_total">
                </div>
                ...
                <div class="mt-3">
                    ...
                    <input class="form-control w-40 px-2 py-1 mr-2 border-2 mt-2" type="text" placeholder="Mã khuyến mãi" name="coupon_code">
